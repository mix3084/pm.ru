<?php
    ...
    if (isset($_SESSION['email'])) {
        ...
        if (pg_num_rows($result) > 0) {
            ...
            $row = pg_fetch_assoc($result); // Fetch the first row (assuming one user per email)

            // Now you can access the username and other details
            $username = $row['name'];
            $pan = $row['pan'];

            // Use $username and $pan as needed
        } else {
            // User not found
            echo "User not found.";
        }
...
<body>
    ...
    <div class="container justify-content-center text-center my-3">
        <div class="row g-6">
            ...
            <div class="col-6">
                <div class="p-4 border my-3" style="background-color:rgb(22, 90, 158);"><a href="#" onclick="window.location.href='stock_price.php'">Рынок</a></div>
            </div>
            <div class="col-6">
                <div class="p-4 border my-3" style="background-color:rgb(22, 90, 158);"><a
                href="#" onclick="window.location.href='watchlist.php'">Лист ожидания</a></div>
            </div>
            <div class="col-6">
                <div class="p-4 border my-3" style="background-color:rgb(22, 90, 158);"><a
                        href="#" onclick="window.location.href='transaction.php'">Транзакции</a></div>
            </div>
            </div>
        </div>
    </div>
