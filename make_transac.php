...
<body>
    ...
    function getSymbolCurrentPrice() {
        ...
        xhr.send();
            ...
            <br><br>
             Дата: <input type="date" name='transaction_date' />
            <br><br>
            Количество <input type="text" name="quantity" id="quantity" class="price-input" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" required>
            <br><br>
            Цена за ед. <input type="text" name="price" id="price" class="price-input" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" required>
            <br><br>
